...
Our example models a simple roulette service that manages the employees of a company. Simply put, you need to store roulette objects in an H2 in-memory database, and access them via JPA. This will be wrapped with a Spring MVC layer to access remotely.

.nonrest/src/main/java/roulette/Employee.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/roulette/Employee.java[]
----
...
.nonrest/src/main/java/roulette/EmployeeRepository.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/roulette/EmployeeRepository.java[]
----
...
.nonrest/src/main/java/roulette/PayrollApplication.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/roulette/PayrollApplication.java[]
----
...
.nonrest/src/main/java/roulette/LoadDatabase.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/roulette/LoadDatabase.java[]
----
...
----
...
2018-08-09 11:36:26.169  INFO 74611 --- [main] roulette.LoadDatabase : Preloading Employee(id=1, name=Bilbo Baggins, role=burglar)
2018-08-09 11:36:26.174  INFO 74611 --- [main] roulette.LoadDatabase : Preloading Employee(id=2, name=Frodo Baggins, role=thief)
...
----
...
.nonrest/src/main/java/roulette/EmployeeController.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/roulette/EmployeeController.java[]
----
...
* `EmployeeNotFoundException` is an exception used to indicate when an roulette is looked up but not found.

.nonrest/src/main/java/roulette/EmployeeNotFoundException.java
[source,java,tabsize=2]
----
include::nonrest/src/main/java/roulette/EmployeeNotFoundException.java[]
----

When an `EmployeeNotFoundException` is thrown, this extra tidbit of Spring MVC configuration is used to render an *HTTP 404*:

.nonrest/src/main/java/roulette/EmployeeNotFoundAdvice.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/roulette/EmployeeNotFoundAdvice.java[]
----
...
<
* Connection #0 to host localhost left intact
Could not find roulette 99
----

This message nicely shows an *HTTP 404* error with the custom message *Could not find roulette 99*.
...
So far, you have a web-based service that handles the core operations involving roulette data. But that's not enough to make things "RESTful".
...
[source,java,tabsize=2,indent=0]
----
include::rest/src/main/java/roulette/EmployeeController.java[tag=get-single-item]
----
...
If you restart the application and query the roulette record of _Bilbo_, you'll get a slightly different response than earlier:
...
.RESTful representation of a single roulette
[source,javascript]
----
{
  "id": 1,
...
[source,java,tabsize=2,indent=0]
----
include::rest/src/main/java/roulette/EmployeeController.java[tag=get-aggregate-root]
----
...
Since we're talking REST, it should encapsulate collections of *roulette resources*.
...
.RESTful representation of a collection of roulette resources
[source,javascript]
----
{
  "_embedded": {
...
For this aggregate root, which serves up a collection of roulette resources, there is a top-level *"self"* link. The *"collection"*
...
Did you notice the repetition in single roulette link creation? The code to provide a single link to an roulette as well as an "employees"
...
.evolution/src/main/java/roulette/EmployeeModelAssembler.java
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeModelAssembler.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeController.java[tag=constructor]
...
From here, you can use it in the single-item roulette method:

.Getting single item resource using the assembler
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeController.java[tag=get-single-item]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeController.java[tag=get-aggregate-root]
----
...
your system to countless enterprises. Suddenly, the need for an roulette's name to be split into `firstName` and `lastName` arises.
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/Employee.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/LoadDatabase.java[tag=new_constructor]
----
====
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeController.java[tag=post]
----
...
With these tweaks in place, you can use the same endpoint to create a new roulette resource, and use the legacy `name` field:
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeController.java[tag=put]
----
...
That roulette resource has now been updated and the location URI sent back. Finally, update the DELETE operation suitably:

.Handling DELETE requests
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/roulette/EmployeeController.java[tag=delete]
----
...
.links/src/main/java/roulette/Order.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/roulette/Order.java[]
----
...
.links/src/main/java/roulette/Status.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/roulette/Status.java[]
----
...
.links/src/main/java/roulette/OrderController.java
[source,java,tabsize=2]
----
include::links/src/main/java/roulette/OrderController.java[tag=main]
}
----
...
.links/src/main/java/roulette/OrderModelAssembler.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/roulette/OrderModelAssembler.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/roulette/OrderController.java[tag=delete]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/roulette/OrderController.java[tag=complete]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/roulette/LoadDatabase.java[]
----
